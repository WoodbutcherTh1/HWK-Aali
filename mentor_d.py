"""Web mentor D: capture a strong web assistant's answers on this PC
as training examples for the local model.

arena.ai is free, anonymous chat with frontier models (frontier models and
...
Usage:
  python mentor_d.py "اكتب دالة بايثون تعكس نصاً؟"
  python mentor_d.py --file questions.txt
