...
FLOWS: dict[str, dict[str, Any]] = {
    ...
    "brain": {
        ...
        "steps": [
            ...
            {"id": "cloud", "t": "السحابة اختيارية فقط",
             "d": "mode=cloud عبر مزودين مسجلين (openai/anthropic/gemini/openrouter) — مفتاح كل مزود من بيئة جهازك، لا يمر عبر المحادثة أبداً.",
