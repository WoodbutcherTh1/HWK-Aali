---
name: connectors
description: How Aali's cloud mode works with optional bring-your-own-key bridges — what "connecting a provider" means and why keys never go through chat.
---
...
| `openai`     | `OPENAI_API_KEY`      | direct bridge, same schema as the router |
